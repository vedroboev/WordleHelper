...
SHORT_WORD_LIST_FILE = os.path.join(DATA_DIR, "wordle_en_allowed.txt")
LONG_WORD_LIST_FILE = os.path.join(DATA_DIR, "wordle_en_complete.txt")
...
choice_config = dict(look_two_ahead=False, 
